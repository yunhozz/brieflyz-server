...
sealed class AuthServiceException(val status: ErrorStatus, message: String) :
...
class VerifyTokenNotFoundException : AuthServiceException(ErrorStatus.VERIFY_TOKEN_NOT_FOUND, "")