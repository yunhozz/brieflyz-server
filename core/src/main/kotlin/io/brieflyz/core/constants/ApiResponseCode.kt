...
enum class SuccessCode(
    ...
    SUBSCRIPTION_INFO_READ_SUCCESS(ApiStatus.OK, "구독 정보 조회 성공"),
    ...
    SUBSCRIBE_SUCCESS(ApiStatus.CREATED, "구독 성공"),
    SUBSCRIPTION_UPDATE_SUCCESS(ApiStatus.CREATED, "구독 정보 수정 성공"),

    // 204 No Content
    LOGOUT_SUCCESS(ApiStatus.NO_CONTENT, "로그아웃 성공"),
    USER_WITHDRAW_SUCCESS(ApiStatus.NO_CONTENT, "회원 탈퇴 성공"),
    SUBSCRIBE_CANCEL_SUCCESS(ApiStatus.NO_CONTENT, "구독 취소 성공")
}
...
enum class ErrorCode(
    ...
    SUBSCRIPTION_NOT_FOUND(ApiStatus.NOT_FOUND, "해당 구독 정보를 찾을 수 없습니다."),
